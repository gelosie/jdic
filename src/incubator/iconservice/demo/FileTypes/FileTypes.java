            ...
            try {
                switch (selectOption) {
                    case SELECT_REGISTER_SYSTEM: {
                            ...
                            associationService.registerSystemAssociation(assoc);
                        }
                        break;
    
                    case SELECT_REGISTER_USER: {
                            Association assoc = getAssociationFields();
                            associationService.registerUserAssociation(assoc);
                        }
                        break;
    
                    case SELECT_UNREGISTER_SYSTEM: {
                            Association assoc = getAssociationFields();
                            associationService.unregisterSystemAssociation(assoc);
                        }
                        break;
                    ...
                    case SELECT_GET_EXT: {
                            ...
                            if ((inputFileExt != null) && (inputFileExt.length() != 0)) {
                                assoc = associationService.getFileExtensionAssociation(inputFileExt);
                            }
                    ...
                    case SELECT_GET_MIME: {
                            ...
                            if ((inputMimeType != null) && (inputMimeType.length() != 0)) {                        
                                assoc = associationService.getMimeTypeAssociation(inputMimeType);
                            }
