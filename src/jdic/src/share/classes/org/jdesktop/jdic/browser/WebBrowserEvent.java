...
public class WebBrowserEvent extends EventObject
{
     ...
     */
    public static final int WEBBROWSER_RETURN_URL              = 7 + WEBBROWSER_FIRST;
    /**
     ...
     */
    public static final int WEBBROWSER_INIT_WINDOW_SUCC        = 21 + WEBBROWSER_FIRST;
    
    /**
     * Event fired when WebBrowser need to get Focus.
     */
    public static final int WEBBROWSER_FOCUS_REQUEST           = 22 + WEBBROWSER_FIRST;
