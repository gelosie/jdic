...
/**
 *  Singleton class describing the Linux platform for JDIC initialization
 *
...
public class LinuxPlatform extends Platform {
	...
	private static LinuxPlatform sSingleton = new LinuxPlatform();


	/**  Private constructor to prevent public construction */
	private LinuxPlatform() { 
		setDirName("linux");
		setJarName("jdic-linux-native.jar");
	}
