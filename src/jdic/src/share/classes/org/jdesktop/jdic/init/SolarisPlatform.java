...
/**
 *  Singleton class describing the Solaris platform for JDIC initialization
 *
...
public class SolarisPlatform extends Platform {
	...
	private static SolarisPlatform sSingleton = new SolarisPlatform();


	/**  Private constructor to prevent public construction */
	private SolarisPlatform() { 
		setDirName("solaris");
		setJarName("jdic-solaris-native.jar");
	}
