...
#ifndef __gen_nsIProfileInternalOld_h__
#define __gen_nsIProfileInternalOld_h__
...
/* starting interface:    nsIProfileInternalOld */
...
/* Header file */
class nsProfileInternal : public nsIProfileInternalOld
{
public:
  NS_DECL_ISUPPORTS
  ...
  nsProfileInternal();
  virtual ~nsProfileInternal();
  /* additional members */
};

/* Implementation file */
NS_IMPL_ISUPPORTS1(nsProfileInternal, nsIProfileInternalOld)
...
#endif /* __gen_nsIProfileInternalOld_h__ */
