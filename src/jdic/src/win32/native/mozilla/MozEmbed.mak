...
CPP=cl.exe
CPP_PROJ=/nologo /MD /W3 /GX /O2 /I "..\..\..\share/native/mozilla" /I "..\..\..\share/native/utils" /I "$(MOZILLA_SRC_HOME)/dist/include/xpcom" /I "$(MOZILLA_SRC_HOME)/dist/include/string" /I "$(MOZILLA_SRC_HOME)/dist/include/necko" /I "$(MOZILLA_SRC_HOME)/dist/include/webbrwsr" /I "$(MOZILLA_SRC_HOME)/dist/include/widget" /I "$(MOZILLA_SRC_HOME)/dist/include/docshell" /I "$(MOZILLA_SRC_HOME)/dist/include/dom" /I "$(MOZILLA_SRC_HOME)/dist/include/uriloader" /I "$(MOZILLA_SRC_HOME)/dist/include/embed_base" /I "$(MOZILLA_SRC_HOME)/dist/include/webshell" /I "$(MOZILLA_SRC_HOME)/dist/include/shistory" /I "$(MOZILLA_SRC_HOME)/dist/include/pref" /I "$(MOZILLA_SRC_HOME)/dist/include/profile" /I "$(MOZILLA_SRC_HOME)/dist/include/find" /I "$(MOZILLA_SRC_HOME)/dist/include/gfx" /I "$(MOZILLA_SRC_HOME)/dist/include/windowwatcher" /I "$(MOZILLA_SRC_HOME)/dist/include/layout" /I "$(MOZILLA_SRC_HOME)/dist/include/webbrowserpersist" /I "$(MOZILLA_SRC_HOME)/dist/include/composer" /I "$(MOZILLA_SRC_HOME)/dist/include/commandhandler" /I "$(MOZILLA_SRC_HOME)/dist/include/imglib2" /I "$(MOZILLA_SRC_HOME)/dist/include" /I "$(MOZILLA_SRC_HOME)/dist/include/nspr" /D "USE_SINGLE_SIGN_ON" /D\
 HAVE_MMINTRIN_H=1 /D HAVE_SNPRINTF=1 /D _WINDOWS=1 /D _WIN32=1 /D WIN32=1 /D XP_PC=1 /D XP_WIN=1 /D XP_WIN32=1 /D HW_THREADS=1 /D WINVER=0x400 /D MSVC4=1 /D STDC_HEADERS=1 /D NEW_H=<new> /D WIN32_LEAN_AND_MEAN=1 /D NO_X11=1 /D _X86_=1 /D D_INO=d_ino /D MOZ_DEFAULT_TOOLKIT="windows" /D MOZ_ENABLE_COREXFONTS=1 /D IBMBIDI=1 /D ACCESSIBILITY=1 /D MOZ_LOGGING=1 /D DETECT_WEBSHELL_LEAKS=1 /D CPP_THROW_NEW=throw() /D MOZ_XUL=1 /D INCLUDE_XUL=1 /D NS_MT_SUPPORTED=1 /D JS_THREADSAFE=1 /D NS_PRINT_PREVIEW=1 /D NS_PRINTING=1 /D MOZ_REFLOW_PERF=1 /D MOZ_REFLOW_PERF_DSP=1 /D MOZILLA_VERSION=\"1.3\" /D "_MOZILLA_CONFIG_H_" /D "MOZILLA_CLIENT" /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D "_AFXDLL" /D "_MBCS" /D "XPCOM_GLUE" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
LINK32=link.exe
LINK32_FLAGS=xpcomglue.lib string_s.lib string_obsolete_s.lib embedstring_s.lib nspr4.lib plc4.lib plds4.lib ole32.lib comdlg32.lib shell32.lib version.lib /nologo /subsystem:windows /incremental:no /pdb:"$(OUTDIR)\MozEmbed.pdb" /machine:I386 /out:"$(OUTDIR)\MozEmbed.exe" /libpath:"$(MOZILLA_SRC_HOME)/dist/lib" 
LINK32_OBJS= \
...
$(DS_POSTBUILD_DEP) : "$(OUTDIR)\MozEmbed.exe"
...
LINK32=link.exe
LINK32_FLAGS=xpcomglue.lib string_s.lib string_obsolete_s.lib embedstring_s.lib nspr4.lib plc4.lib plds4.lib ole32.lib comdlg32.lib shell32.lib version.lib /nologo /subsystem:windows /incremental:yes /pdb:"$(OUTDIR)\MozEmbed.pdb" /debug /machine:I386 /out:"$(OUTDIR)\MozEmbed.exe" /pdbtype:sept /libpath:"$(MOZILLA_SRC_HOME)/dist/lib" 
LINK32_OBJS= \
	"$(INTDIR)\BrowserFrm.obj" \
	"$(INTDIR)\BrowserImpl.obj" \
	"$(INTDIR)\BrowserToolTip.obj" \
...
$(DS_POSTBUILD_DEP) : "$(OUTDIR)\MozEmbed.exe" "$(OUTDIR)\MozEmbed.bsc"
	echo Helper for Post-build step > "$(DS_POSTBUILD_DEP)"
...
CPP_SWITCHES=/nologo /MD /W3 /GX /O2 /I "..\..\..\share/native/mozilla" /I "..\..\..\share/native/utils" /I "$(MOZILLA_SRC_HOME)/dist/include/xpcom" /I "$(MOZILLA_SRC_HOME)/dist/include/string" /I "$(MOZILLA_SRC_HOME)/dist/include/necko" /I "$(MOZILLA_SRC_HOME)/dist/include/webbrwsr" /I "$(MOZILLA_SRC_HOME)/dist/include/widget" /I "$(MOZILLA_SRC_HOME)/dist/include/docshell" /I "$(MOZILLA_SRC_HOME)/dist/include/dom" /I "$(MOZILLA_SRC_HOME)/dist/include/uriloader" /I "$(MOZILLA_SRC_HOME)/dist/include/embed_base" /I "$(MOZILLA_SRC_HOME)/dist/include/webshell" /I "$(MOZILLA_SRC_HOME)/dist/include/shistory" /I "$(MOZILLA_SRC_HOME)/dist/include/pref" /I "$(MOZILLA_SRC_HOME)/dist/include/profile" /I "$(MOZILLA_SRC_HOME)/dist/include/find" /I "$(MOZILLA_SRC_HOME)/dist/include/gfx" /I "$(MOZILLA_SRC_HOME)/dist/include/windowwatcher" /I "$(MOZILLA_SRC_HOME)/dist/include/layout" /I "$(MOZILLA_SRC_HOME)/dist/include/webbrowserpersist" /I "$(MOZILLA_SRC_HOME)/dist/include/composer" /I "$(MOZILLA_SRC_HOME)/dist/include/commandhandler" /I "$(MOZILLA_SRC_HOME)/dist/include/imglib2" /I "$(MOZILLA_SRC_HOME)/dist/include" /I "$(MOZILLA_SRC_HOME)/dist/include/nspr" /D "USE_SINGLE_SIGN_ON" /D\
...
CPP_SWITCHES=/nologo /MD /W3 /GX /O2 /I "..\..\..\share/native/mozilla" /I "..\..\..\share/native/utils" /I "$(MOZILLA_SRC_HOME)/dist/include/xpcom" /I "$(MOZILLA_SRC_HOME)/dist/include/string" /I "$(MOZILLA_SRC_HOME)/dist/include/necko" /I "$(MOZILLA_SRC_HOME)/dist/include/webbrwsr" /I "$(MOZILLA_SRC_HOME)/dist/include/widget" /I "$(MOZILLA_SRC_HOME)/dist/include/docshell" /I "$(MOZILLA_SRC_HOME)/dist/include/dom" /I "$(MOZILLA_SRC_HOME)/dist/include/uriloader" /I "$(MOZILLA_SRC_HOME)/dist/include/embed_base" /I "$(MOZILLA_SRC_HOME)/dist/include/webshell" /I "$(MOZILLA_SRC_HOME)/dist/include/shistory" /I "$(MOZILLA_SRC_HOME)/dist/include/pref" /I "$(MOZILLA_SRC_HOME)/dist/include/profile" /I "$(MOZILLA_SRC_HOME)/dist/include/find" /I "$(MOZILLA_SRC_HOME)/dist/include/gfx" /I "$(MOZILLA_SRC_HOME)/dist/include/windowwatcher" /I "$(MOZILLA_SRC_HOME)/dist/include/layout" /I "$(MOZILLA_SRC_HOME)/dist/include/webbrowserpersist" /I "$(MOZILLA_SRC_HOME)/dist/include/composer" /I "$(MOZILLA_SRC_HOME)/dist/include/commandhandler" /I "$(MOZILLA_SRC_HOME)/dist/include/imglib2" /I "$(MOZILLA_SRC_HOME)/dist/include" /I "$(MOZILLA_SRC_HOME)/dist/include/nspr" /I "$(MOZILLA_SRC_HOME)/dist/include/embedstring" /D "USE_SINGLE_SIGN_ON" /D\
 HAVE_MMINTRIN_H=1 /D HAVE_SNPRINTF=1 /D _WINDOWS=1 /D _WIN32=1 /D WIN32=1 /D XP_PC=1 /D XP_WIN=1 /D XP_WIN32=1 /D HW_THREADS=1 /D WINVER=0x400 /D MSVC4=1 /D STDC_HEADERS=1 /D NEW_H=<new> /D WIN32_LEAN_AND_MEAN=1 /D NO_X11=1 /D _X86_=1 /D D_INO=d_ino /D MOZ_DEFAULT_TOOLKIT="windows" /D MOZ_ENABLE_COREXFONTS=1 /D IBMBIDI=1 /D ACCESSIBILITY=1 /D MOZ_LOGGING=1 /D DETECT_WEBSHELL_LEAKS=1 /D CPP_THROW_NEW=throw() /D MOZ_XUL=1 /D INCLUDE_XUL=1 /D NS_MT_SUPPORTED=1 /D JS_THREADSAFE=1 /D NS_PRINT_PREVIEW=1 /D NS_PRINTING=1 /D MOZ_REFLOW_PERF=1 /D MOZ_REFLOW_PERF_DSP=1 /D MOZILLA_VERSION=\"1.3\" /D "_MOZILLA_CONFIG_H_" /D "MOZILLA_CLIENT" /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D "_AFXDLL" /D "_MBCS" /D "XPCOM_GLUE" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
