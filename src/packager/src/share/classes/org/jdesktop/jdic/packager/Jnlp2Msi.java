 ...
 * into a MSI package. This class is entered via the canonical `public static 
 * void main` entry point and reads the command line arguments. 
 * 
 * <pre>
 * The command line to use this class is:
 * java [property options] &lt;-DMSSDKDir=&lt;value&gt;&gt; org.jdesktop.jdic.packager.Jnlp2Msi &lt;JNLP file path&gt;
 * 
 ...
 *   -DPackageName=&lt;value&gt;: set the name of the generated MSI package. 
 *     The default value is the jnlp file name without extension.
 *   -DOutputDir=&lt;value&gt;: set the directory where the generated MSI package 
 ...
 *     The default value is false.
 *   -DBannerJpgFile=&lt;value&gt;: set the path of the banner picture which will be used in 
 *     the Windows MSI installation GUI. If not specified, a default jpeg file contained in 
 *     the jar file will be used.
 *   -DPanelJpgFile=&lt;value&gt;: set the path of the panel picture which will be used in 
 *     the Windows MSI installation GUI. If not specified, a default jpeg file contained in 
 *     the jar file will be used.
 * &lt;-DMSSDKDir=&lt;value&gt;&gt;: set the directory where Windows SDK Update gets installed.
 * </pre>
 * <p>
 ...
 * @see Jnlp2Pkg
 */
public class Jnlp2Msi {
    /**
     * Command line entry point. This method starts generating a MSI package 
